...
// .wrangler/tmp/pages-1d52ra/functionsWorker-0.13800825217717283.mjs
...
async function onRequestGet({ env, request }) {
  ...
  const json = /* @__PURE__ */ __name2((data, status = 200) => new Response(JSON.stringify(data, null, 2), {
    status,
    headers: {
  ...
  const withTimeout = /* @__PURE__ */ __name2(async (p, ms, label) => {
  ...
  const fetchJson = /* @__PURE__ */ __name2(async (url, init = {}, timeoutMs = 8e3) => {
  ...
  const rpcCall = /* @__PURE__ */ __name2(async (method, params = [], timeoutMs = 8e3) => {
  ...
  const hexToInt = /* @__PURE__ */ __name2((h) => {
    if (!h || h === "null") return null;
    if (typeof h !== "string") return null;
    return parseInt(h.startsWith("0x") ? h.slice(2) : h, 16);
  }, "hexToInt");
  const cgFetchJson = /* @__PURE__ */ __name2(async (url, timeoutMs = 8e3) => {
  ...
  try {
    const SAMPLE_N = 12;
    const blk = await rpcCall("eth_getBlockByNumber", ["latest", true], 12e3);
    ...
    if (!txs.length) {
      ...
      const isContract = /* @__PURE__ */ __name2(async (addr) => {
      ...
      const pct = /* @__PURE__ */ __name2((x) => total ? x * 100 / total : null, "pct");
      out.activity_sample = {
        sample_n: txs.length,
...
// .wrangler/tmp/bundle-xtU27Q/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xtU27Q/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.13800825217717283.js.map
